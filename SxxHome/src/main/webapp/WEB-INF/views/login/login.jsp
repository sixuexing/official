...
<link href="${pageContext.request.contextPath}/include/css/base.css" rel="stylesheet" type="text/css"/>
<link href="${pageContext.request.contextPath}/include/css/login.css" rel="stylesheet" type="text/css"/>
...
<script>var basedir='include/ui/';</script>
<script src="${pageContext.request.contextPath}/include/ui/do.js"></script>
<script src="${pageContext.request.contextPath}/include/ui/config.js"></script>
<script>
